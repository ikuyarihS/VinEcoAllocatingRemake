...
namespace VinEcoAllocatingRemake.AllocatingInventory.Models
{
    ...
    public class CoordStructure : IDisposable
    {
        ...
        {
            this.dicCoord              = new Dictionary<(DateTime DatePo, Product Product, CustomerOrder Order), (DateTime DateFc, SupplierForecast Supply)>();
            ...
            this.dicFC                 = new Dictionary<(DateTime DateFc, string ProductCode, string SupplierCode), (SupplierForecast Supply, bool)>();
            this.dicPO                 = new Dictionary<(DateTime DatePo, string ProductCode, string CustomerKeyCode), (CustomerOrder Order, bool)>();
