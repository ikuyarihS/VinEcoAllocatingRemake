...
namespace VinEcoAllocatingRemake.AllocatingInventory
{
    ...
    public partial class Utilities
    {
        ...
        ///     Requires filePath - theName - listArrays - listColumnNames - listTypes - yesHeader - yesZero.
        /// </summary>
        ...
        /// <param name="param">filePath - theName - listArrays - listColumnNames - listTypes - yesHeader - yesZero</param>
                                       ...
                                       bool yesZero ) param)
        {
            try
            {
                    ...
                    SpreadsheetDocumentType.Workbook))
                {
                    ...
                    foreach (object[,] array in param.listArrays)
                    {
                        ...
                        if (param.yesHeader)
                        {
                            ...
                            for (var columnNum = 1; columnNum <= array.GetUpperBound(1); ++columnNum)
                            {
                                ...
                                writer.WriteElement(new CellValue(param.listColumnNames[columnNum - 1]));
                        ...
                        {
                            // create a new list of attributes
                            attributes = new List<OpenXmlAttribute> { new OpenXmlAttribute("r", null, (param.yesHeader ? rowNum + 1 : rowNum).ToString()) };
                            ...
                            for (var columnNum = 1; columnNum <= array.GetUpperBound(1); columnNum++)
                            {
                                Type type = param.listTypes[columnNum - 1];
                                ...
                                attributes = new List<OpenXmlAttribute>
                                                 {
                                                     ...
                                                     // Add the cell reference attribute
                                                     new OpenXmlAttribute("r", string.Empty, $"{dicColName[columnNum]}{(param.yesHeader ? rowNum + 1 : rowNum).ToString(CultureInfo.InvariantCulture)}")
                                                 };
                                ...
                                // write the cell value
                                if (!param.yesZero && array[rowNum - 1, columnNum - 1] != null && array[rowNum - 1, columnNum - 1].ToString() != "0")
                                {
